...
@section('title', 'Aktivitas Resertifikasi')
...
<div class="container-fluid py-4" style="max-width: 1200px;">
    ...
    <div class="breadcrumb-bar">
        ...
        <span>Resertifikasi</span>
    </div>

    {{-- Header --}}
    <div class="page-header-bar">
        <div>
            <h2><i class="fa-solid fa-rotate me-2" style="color:#0369a1;"></i>Aktivitas Resertifikasi</h2>
            <p>Riwayat pengajuan perpanjangan sertifikat beserta status terkini dan progress setiap tahap.</p>
        </div>
        @if(!$isInternal)
            <a href="{{ route('pengajuan.resertifikasi') }}" class="btn btn-primary fw-semibold px-4 shadow-sm" style="border-radius: 10px; font-size: 14px;" id="btn-ajukan-resertifikasi">
                <i class="fa-solid fa-plus me-1"></i> Ajukan Resertifikasi
            </a>
        @endif
    </div>
